...
Repo.prototype.install = function() {
    ...
    return fs.remove(this.dir('app')).catch(err => null)
        .then(() => exec(this.dir(), 'git -c http.sslVerify=false clone $ $ --single-branch -b $ --depth 1 --quiet', this.repo, this._id + '.app', this.branch))
